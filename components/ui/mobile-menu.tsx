    ...
    <div className="flex md:hidden">
      ...
      <div ref={mobileNav}>
        <Transition
          ...
          as="nav"
          id="mobile-nav"
          className="absolute left-0 top-full z-20 w-full rounded-xl bg-black shadow-lg shadow-black/[0.03] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(theme(colors.gray.100),theme(colors.gray.200))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]"
        ...
        >
          <ul className="p-2 text-sm">
            <li>
              <Link
                href="#"
                className="flex rounded-lg px-2 py-1.5 text-white hover:bg-[#030442]"
